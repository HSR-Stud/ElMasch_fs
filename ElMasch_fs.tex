...
\frac{60 \cdot q_1 \cdot U_{i20}^2 \cdot R'_2}{2 \pi n_1 s \cdot \left(\left(\frac{R'_2}{s}\right)^2 +
X_{2\sigma}'^2\right)} \qquad M_K = \frac{60 \cdot q_1}{4 \pi n_1} \cdot \frac{U_1^2}{X'_{2\sigma}}$$
...
\begin{tabular}{ll}
  ...
  \end{dtabular} &
  \begin{mtabular}{l}
    $\fmm \cn{I_1} = \cn{I_{Fe}} + \cn{I_\mu} + \cn{I_{2}'} \approx \cn{I_{2}'} \quad \cn{U_{i20}} \approx
    \cn{U_1}$ \\
    ...
    $\fmm U_{Y} = \frac{U_{\Delta}}{\sqrt{3}} \qquad M_{Str} = \frac{M_{tot}}{3}$    
  \end{mtabular}
\end{tabular}
