...
%       
  ...
  \begin{tabular}{ll}
    ...
    \multicolumn{2}{l}{$\fmm I_2 = \frac{U_{i20}}{\sqrt{ \left( \frac{R'_2}{s} \right)^2 +
    X_{2\sigma}'^2 }}$}
  \end{tabular}
\end{tabular}
...
$$M = r \cdot F_1 = R \cdot I_2 B l_2 = \frac{60}{2\pi n_1} \cdot \frac{P_{Cu2}}{s} \qquad \frac{M}{M_K} = \frac{2}{\frac{s}{s_k} + \frac{s_k}{s}}$$
